...
// File contracts/tokenomics/RBTC20.sol
...
contract RBTC20 is IERC20, Ownable {
    ...
    function withdraw(uint256 amount) external {
        require(amount <= collateral.balanceOf(address(this)), "INSUFFICIENT_COLLATERAL_BALANCE");
